const translations = {
  en: {
    ...
    "projects.label":"04 / PROJECTS","projects.title":"Research Projects","projects.placeholder":"Project details coming soon","publications.label":"05 / PUBLICATIONS","publications.title":"Publications","publications.paper":"A Singularity-Free Vector-Field-Based Framework for Safe Distributed Motion Coordination of Multi-Robot Systems","publications.fixed":"Fixed-wing UAV Systems","publications.diffusion":"Diffusion-based Robot Planning","publications.nonlinear":"Nonlinear Systems","publications.placeholder":"Publication details coming soon","publications.view":"View paper ↗","contact.label":"06 / CONTACT","contact.title":"Let's Connect","contact.text":"lizheng2024@hnu.edu.cn","contact.button":"lizheng2024@hnu.edu.cn","footer.text":"Academic Homepage"
  },
  zh: {
    ...
    "projects.label":"04 / 科研项目","projects.title":"科研项目","projects.placeholder":"项目详情即将更新","publications.label":"05 / 论文成果","publications.title":"论文成果","publications.paper":"A Singularity-Free Vector-Field-Based Framework for Safe Distributed Motion Coordination of Multi-Robot Systems","publications.fixed":"固定翼无人机系统","publications.diffusion":"基于扩散模型的机器人规划","publications.nonlinear":"非线性系统","publications.placeholder":"论文详情即将更新","publications.view":"查看论文 ↗","contact.label":"06 / 联系方式","contact.title":"保持联系","contact.text":"lizheng2024@hnu.edu.cn","contact.button":"lizheng2024@hnu.edu.cn","footer.text":"学术个人主页"
  }
};
