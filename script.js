const translations = {
  en: {
    ...
    "research.label":"03 / RESEARCH","research.title":"Research Interests","research.note":"From mathematical modeling to embodied intelligence, I study autonomous systems that are explainable, robust, and deployable.","research.r1.title":"Nonlinear Systems","research.r1.text":"Modeling, stability analysis, and control of complex dynamic systems.","research.r2.title":"Fixed-wing UAV Systems","research.r2.text":"Motion planning, guidance, and control for autonomous aerial vehicles.","research.r3.title":"Diffusion-based Robot Planning","research.r3.text":"Learning-based path planning and intelligent navigation in complex environments.",
    "projects.label":"04 / PROJECTS","projects.title":"Research Projects","projects.placeholder":"Project details coming soon","publications.label":"05 / PUBLICATIONS","publications.title":"Publications","publications.paper":"Selected IEEE publication","publications.view":"View paper ↗","contact.label":"06 / CONTACT","contact.title":"Let's Connect","contact.text":"Academic contact details coming soon.","contact.button":"Send an email <span>↗</span>","footer.text":"Academic Homepage"
  },
  zh: {
    ...
    "projects.label":"04 / 科研项目","projects.title":"科研项目","projects.placeholder":"项目详情即将更新","publications.label":"05 / 论文成果","publications.title":"论文成果","publications.paper":"IEEE 论文成果","publications.view":"查看论文 ↗","contact.label":"06 / 联系方式","contact.title":"保持联系","contact.text":"联系方式即将更新。","contact.button":"发送邮件 <span>↗</span>","footer.text":"学术个人主页"
  }
};
